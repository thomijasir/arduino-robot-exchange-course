...
const int motorRPin1 = 9; // signal pin 1 for the right motor, connect to IN1               
const int motorRPin2 = 10;  // signal pin 2 for the right motor, connect to IN2
const int motorREnable = 3; // enable pin for the right motor (PWM enabled)

const int motorLPin1 = 6; // signal pin 1 for the left motor, connect to IN3           
const int motorLPin2 = 5; // signal pin 2 for the left motor, connect to IN4
const int motorLEnable = 11; // enable pin for the left motor (PWM enabled)
